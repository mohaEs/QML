# -*- coding: utf-8 -*-
"""HQNN-Parallel-PAPILA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11hXTlGuVsDjmpFx1OHkhGf25VyuCldmT

## This notebook presents the reproducible procedure that we followed in comparing the performance of Hybrid Quantum Neural Networks-Parallel and Classical Convolutional Neural Networks on the PAPILA dataset. The PAPILA dataset is a glaucoma-focused dataset with 89 full fundus images. The dataset was produced in Spain and is labeled with three-category classification (non-glaucoma, early glaucoma, and advanced glaucoma).
...
MODEL_SAVE_PATH = "/content/drive/MyDrive/OphAI-Harvard/QMLExperiments/PAPILA_models_QNN-Parallel/"
